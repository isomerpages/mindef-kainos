...
<p style="text-align: justify;">Immerse yourself in a captivating environment where the frontiers of technology are explored and celebrated. With a focus on tech-driven solutions, AI, and data analytics, KAINOS as the inaugural Army Experimentation exercise showcases the latest tech breakthroughs and offers a glimpse into the possibilities ahead.</p>
...
<p style="text-align: justify;">Organised by Signal Formation, this year's theme, "Power to the Edge" promises to bring cutting edge technology for our ops users within Stagmont Camp. View the <a class="button primary" href="/event-schedule/">event schedule here</a>.</p>
